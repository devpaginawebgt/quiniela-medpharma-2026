{{--
    Carousel de banners para secciones internas (calendario, equipos, estadios, grupos, mis-predicciones).
    Usa Swiper.js con autoplay (4000ms) y paginación por dots.
    Aspect ratio: 1080/480 (móvil) | 1920/500 (lg+)
...
<div class="relative w-full bg-complementary-primary">
    <div class="swiper carousel-section-banners w-full max-w-480 mx-auto aspect-1080/480 lg:aspect-1920/500">
...
document.addEventListener('DOMContentLoaded', function () {
    new Swiper('.carousel-section-banners', {
        loop: true,
        autoplay: { delay: 4000, disableOnInteraction: false },
        pagination: { el: '.carousel-section-banners .swiper-pagination', clickable: true },
    });
});
</script>
@endif
